...
if __name__ == '__main__':
    #Radar point cloud reading
    pc= RadarPointCloud(np.random.rand(18, 3))

    data_load= pc.from_file("/media/disk1/cam_rad_fusion/CenterFusion/data/v1.0-mini/sweeps/RADAR_FRONT/n008-2018-08-01-15-16-36-0400__RADAR_FRONT__1533151603630245.pcd")
    print(data_load.points.shape)
    #Create a dataframe for data
    df= pd.DataFrame(data_load.points.T, columns= ["x", "y", "z", "dyn_prop", "id", 'rcs', 'vx', 'vy', 'vx_comp', 'vy_comp', 'is_quality_valid', 'ambig_state', 'x_rms', 'y_rms', 'invalid_state', 'pdh0', 'vx_rms', 'vy_rms'])
    print(df)
    df.to_csv("data_frame.csv")
    # RadarPointCloud(pc).from_file("/media/disk1/cam_rad_fusion/CenterFusion/data/v1.0-mini/sweeps/RADAR_FRONT/n008-2018-08-01-15-16-36-0400__RADAR_FRONT__1533151603630245.pcd")